...
module blobPrivateEndpoint 'br/public:avm/res/network/private-endpoint:0.12.0' = if (enableBlob) {
...
module queuePrivateEndpoint 'br/public:avm/res/network/private-endpoint:0.12.0' = if (enableQueue) {
...
module tablePrivateEndpoint 'br/public:avm/res/network/private-endpoint:0.12.0' = if (enableTable) {
